...
require (
	github.com/PretendoNetwork/grpc/go v0.0.0-20260121223054-9ec9eefa9566
	github.com/PretendoNetwork/nex-go/v2 v2.3.0
	github.com/PretendoNetwork/nex-protocols-common-go/v2 v2.4.1-0.20260129003605-d76355873d2a
